...
${OBJECTDIR}/_ext/a0c56a08/Batcher.o: /home/maism/src/hopsfs-elastic-notifier/Batcher.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/local/mysql/include -I/usr/local/mysql/include/storage/ndb -I/usr/local/mysql/include/storage/ndb/ndbapi -I/usr/local/mysql/include/storage/ndb/mgmapi -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/a0c56a08/Batcher.o /home/maism/src/hopsfs-elastic-notifier/Batcher.cpp

${OBJECTDIR}/_ext/a0c56a08/FsMutationsBatcher.o: /home/maism/src/hopsfs-elastic-notifier/FsMutationsBatcher.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/a0c56a08
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/local/mysql/include -I/usr/local/mysql/include/storage/ndb -I/usr/local/mysql/include/storage/ndb/ndbapi -I/usr/local/mysql/include/storage/ndb/mgmapi -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/a0c56a08/FsMutationsBatcher.o /home/maism/src/hopsfs-elastic-notifier/FsMutationsBatcher.cpp
...
${OBJECTDIR}/_ext/a0c56a08/MetadataTableTailer.o: /home/maism/src/hopsfs-elastic-notifier/MetadataTableTailer.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/a0c56a08
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/local/mysql/include -I/usr/local/mysql/include/storage/ndb -I/usr/local/mysql/include/storage/ndb/ndbapi -I/usr/local/mysql/include/storage/ndb/mgmapi -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/a0c56a08/MetadataTableTailer.o /home/maism/src/hopsfs-elastic-notifier/MetadataTableTailer.cpp

${OBJECTDIR}/_ext/a0c56a08/NdbDataReader.o: /home/maism/src/hopsfs-elastic-notifier/NdbDataReader.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/a0c56a08
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/local/mysql/include -I/usr/local/mysql/include/storage/ndb -I/usr/local/mysql/include/storage/ndb/ndbapi -I/usr/local/mysql/include/storage/ndb/mgmapi -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/a0c56a08/NdbDataReader.o /home/maism/src/hopsfs-elastic-notifier/NdbDataReader.cpp
