...
#define FORMAT_STATS(ITEMS) ((dynamic_cast<ostringstream &>(ostringstream().seekp(0,ios_base::cur) << ITEMS )).str().c_str())
...
#define LOG_STATS(msg) Logger::stats(FORMAT_STATS(msg))
...
public:
    ...
    static void stats(const char* msg);
